import{E as b}from"./index-DQKEvUsp.js";import{_ as M,g as E,c as v,b as I,a as m,w as u,F as w,r as h,o as _,d as R}from"./index-DQxC938F.js";import"./CesiumEarth-D0reHEmA.js";class P{constructor(e){this._delegate=new Cesium.PrimitiveCollection,this._primitives=e.scene.primitives.add(this._delegate),this.img="data:image/png;base64,"}updatePrimitives(e,t,n,a,l){let o=this.fromArray(e),s=this.computeEllipsePositions(o,n),p=this.computeEllipsePositions(o,a*.7),c=this.computeEllipsePositions(o,a);const r={geometryInstances:new Cesium.GeometryInstance({geometry:new Cesium.PolygonGeometry({polygonHierarchy:new Cesium.PolygonHierarchy(this.computeEllipsePositions(o,a*2)),perPositionHeight:!0}),asynchronous:!1})};let y=new Cesium.Primitive(r);y.appearance=new Cesium.EllipsoidSurfaceAppearance({material:Cesium.Material.fromType(Cesium.Material.CircleRingType,{color:Cesium.Color.fromCssColorString(l)})});let g=new Cesium.Primitive(r);g.appearance=new Cesium.EllipsoidSurfaceAppearance({material:Cesium.Material.fromType(Cesium.Material.CircleRotateType,{color:Cesium.Color.fromCssColorString(l),image:this.getCircleImage()})});let i=new Cesium.Primitive({geometryInstances:this.createCylinderInstance(s,p,t),appearance:new Cesium.EllipsoidSurfaceAppearance({material:Cesium.Material.fromType(Cesium.Material.CylinderFadeType,{color:Cesium.Color.fromCssColorString(l)})}),asynchronous:!1});Cesium.GroundPrimitive.initializeTerrainHeights().then(()=>{this._delegate.add(y),this._delegate.add(g),this._delegate.add(i)}),Cesium.Resource.fetchImage({url:this.img}).then(A=>{let C=new Cesium.Primitive({geometryInstances:this.createCylinderInstance(s,c,t),appearance:new Cesium.EllipsoidSurfaceAppearance({material:Cesium.Material.fromType(Cesium.Material.CylinderParticlesType,{color:Cesium.Color.fromCssColorString(l),image:this.getParticlesImage(A)})}),asynchronous:!1});this._delegate.add(C)})}computeEllipsePositions(e,t){let n=Cesium.EllipseGeometryLibrary.computeEllipsePositions({center:Cesium.Cartesian3.fromDegrees(e.lng,e.lat,e.alt,Cesium.Ellipsoid.WGS84),semiMajorAxis:t,semiMinorAxis:t,rotation:0,granularity:.005},!1,!0),a=Cesium.Cartesian3.unpackArray(n.outerPositions);return a.push(a[0]),a}getCircleImage(){let e=document.createElement("canvas");e.width=512,e.height=512;let t=e.getContext("2d");return t.fillStyle="rgba(255,255,255,0)",t.strokeStyle="rgba(255, 255, 255,255)",t.setLineDash([50,50]),t.lineWidth=30,t.beginPath(),t.arc(256,256,150,0,Math.PI*2,!0),t.stroke(),t.restore(),e}createCylinderInstance(e,t,n){let a=t.slice(),l=t.length,o=2*l,s=[],p=1/(l-1),c=[],r=[];const y=(i,A=0)=>{let C=Cesium.Cartographic.fromCartesian(i);return C.height+=A,Cesium.Cartographic.toCartesian(C)};for(let i=0;i<l;i++){r.push(y(e[i],n)),s.push(i*p,0);let A=i+1,C=(i+1)%l,f=o-A;c.push(f-1,f,i),c.push(i,C,f-1)}for(let i in r)a.push(r[l-i-1]),s.push(1-i*p,1);let g=Cesium.PolygonGeometry.createGeometry(new Cesium.PolygonGeometry({polygonHierarchy:new Cesium.PolygonHierarchy(a),perPositionHeight:!0}));return g.indices=c,g.attributes.st.values=s,new Cesium.GeometryInstance({geometry:g})}getParticlesImage(e){let t=document.createElement("canvas");t.width=64,t.height=256;let n=t.getContext("2d");return n.clearRect(0,0,64,256),n.drawImage(e,0,0),n.drawImage(e,33,0),t}fromArray(e){let t={};return Array.isArray(e)&&(t.lng=e[0]||0,t.lat=e[1]||0,t.alt=e[2]||0,t.heading=e[3]||0,t.pitch=e[4]||0,t.roll=e[5]||0),t}}Cesium.Material.CircleRingType="CircleRing";Cesium.Material._materialCache.addMaterial(Cesium.Material.CircleRingType,{fabric:{type:Cesium.Material.CircleRingType,uniforms:{color:new Cesium.Color(1,0,0,.7)},source:`
    ...
    `},translucent:function(d){return!0}});Cesium.Material.CylinderFadeType="CylinderFade";Cesium.Material._materialCache.addMaterial(Cesium.Material.CylinderFadeType,{fabric:{type:Cesium.Material.CylinderFadeType,uniforms:{color:new Cesium.Color(1,0,0,.7)},source:`uniform vec4 color;
    czm_material czm_getMaterial(czm_materialInput materialInput){
      czm_material material = czm_getDefaultMaterial(materialInput);
      vec2 st = materialInput.st;
      ...
      `},translucent:function(d){return!0}});const T={class:"toolPane"},G={__name:"index",setup(d){const e=E({cylinderShow:!1,length:2e3,topRadius:1,bottomRadius:200,color:"#ff0000"}),t=n=>{new P(viewer).updatePrimitives([120.38710189330764,31.145008271831585,0],e.length,e.topRadius,e.bottomRadius,e.color),viewer.camera.flyTo({destination:Cesium.Cartesian3.fromDegrees(120.38710189330764,31.145008271831585,1e4)})};return(n,a)=>{const l=h("el-slider"),o=h("el-form-item"),s=h("el-color-picker"),p=h("el-button"),c=h("el-form");return _(),v(w,null,[a[5]||(a[5]=I("div",{id:"windy"},null,-1)),m(b),I("div",T,[m(c,{inline:!1,model:e,"label-width":"auto"},{default:u(()=>[m(o,{label:"高度"},{default:u(()=>[m(l,{modelValue:e.length,"onUpdate:modelValue":a[0]||(a[0]=r=>e.length=r),max:1e4,min:1},null,8,["modelValue"])]),_:1}),m(o,{label:"上半径"},{default:u(()=>[m(l,{modelValue:e.topRadius,"onUpdate:modelValue":a[1]||(a[1]=r=>e.topRadius=r),max:100,min:1},null,8,["modelValue"])]),_:1}),m(o,{label:"下半径"},{default:u(()=>[m(l,{modelValue:e.bottomRadius,"onUpdate:modelValue":a[2]||(a[2]=r=>e.bottomRadius=r),max:1e3,min:10},null,8,["modelValue"])]),_:1}),m(o,{label:"颜色"},{default:u(()=>[m(s,{modelValue:e.color,"onUpdate:modelValue":a[3]||(a[3]=r=>e.color=r)},null,8,["modelValue"])]),_:1}),m(o,{label:""},{default:u(()=>[m(p,{type:"primary",onClick:t},{default:u(()=>a[4]||(a[4]=[R("光锥")])),_:1})]),_:1})]),_:1},8,["model"])])],64)}}},U=M(G,[["__scopeId","data-v-f3fabb29"]]);export{U as default};
